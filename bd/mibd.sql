...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-12-2015 a las 06:43:31
...
INSERT INTO `pizzas` (`idPizza`, `Precio`, `Descripcion`, `foto`, `INGREDIENTES`) VALUES
(2, 80, 'Anchoas', '', 'Salsa de tomate, Anchoas, Morrones'),
(3, 85, 'Fugazza', '', 'Cebolla en rodajas, Sal, Aceite'),
(4, 90, 'Americana', '', 'Salsa de tomate, Muzzarella, Cebolla'),
(5, 90, 'Napolitana', '', 'Salsa de tomate, Muzzarella, Rodajas de tomate'),
(6, 100, 'Roquefort', '', 'Salsa de tomate, Muzzarella, Roquefort\n'),
(7, 100, 'Calabresa', '', 'Salsa de tomate, Muzzarella, Rodajas de longaniza\n'),
(9, 150, 'Especial dolores fonzi', '', 'Muzzarella c/ 3 bolsitas "verdes"'),
(11, 150, 'Jamon y Morrones', '', 'Salsa de tomate, Muzarella, Jamon cocido, Morrones'),
(12, 100, 'Bolognesa', '', 'Muzzarella, Salsa bolognesa'),
(13, 120, 'Papas Pay', '', 'Salsa de tomate, Muzzarella, Papas pay, Ketchup'),
(14, 150, 'Rucula', '', 'Salsa de tomate, Rucula, Jamon crudo, Parmesano'),
(15, 70, 'Muzzarella', '', 'Salsa de tomate, muzzarella');
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `telefonocel` varchar(100) DEFAULT NULL,
  `telefonofijo` varchar(100) DEFAULT NULL
...
INSERT INTO `usuarios` (`idUsuario`, `nombreUsuario`, `password`, `tipo`, `email`, `foto`, `Direccion`, `Localidad`, `Provincia`, `sexo`, `telefonocel`, `telefonofijo`) VALUES
(1, 'MSantosN', 'amorto123', 'Administrador', 'martin.santosnaon@hotmail.com', 'MSantosN20151202204220.png', 'Julio Arin 921', 'Jose Marmol', 'Buenos Aires', 'Masculino', '1161815149', '42947289'),
(5, 'Magmar', '123', 'Administrador', 'agusmann@hotmail.com', 'Magmar20151202204135.jpg', 'Bynnon 2478', 'Jose Marmol', 'Buenos Aires', 'Masculino', '1159245896', '42943289'),
(6, 'Homero', '123456', 'Normal', 'homero@simpson.com', 'Homero20151119192100.jpg', 'Plaza Esteban Adrogué 31', 'Adrogue', 'Buenos Aires', 'Masculino', NULL, NULL),
(7, 'Walocha', 'ramonramirez0', 'Normal', 'elwally_yo@hotmail.com', 'Walocha20151124224540.jpg', 'bouchard 2364', 'jose marmol', 'Buenos Aires', 'Masculino', NULL, NULL),
(23, 'cambia23', 'cambia22', 'Administrador', 'pepito@lalala', 'cambia2320151202204245.jpg', 'Eden 1200', 'La Falda', 'Córdoba', 'Masculino', '1159903410', '42362377'),
(26, 'test', 'test', 'Normal', 'test@test.com', 'test20151204144434.jpg', 'Este usuario no es ubicable', '', '', 'Masculino', NULL, NULL),
(27, 'lalala', 'lala', 'Normal', 'lala@lalala.com', 'lalala20151210211525.jpg', 'Este usuario no es ubicable', '', '', 'Masculino', NULL, NULL);
...
--
ALTER TABLE `usuarios`
  MODIFY `idUsuario` int(100) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
